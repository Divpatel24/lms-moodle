...
def faculty_update_lecture():
    try:
        if admin_login_session() == "faculty":
            ...
            lecture_course_id = request.form.get('lectureDepartmentId')
            lecture_semester_id = request.form.get('lectureSemesterId')
            lecture_subject_id = request.form.get('lectureSubjectId')
            lecture_date = request.form.get('lectureDate')
            lecture_day = request.form.get('lectureDay')
            ...
            lecture_vo.lecture_course_id = lecture_course_id
            lecture_vo.lecture_semester_id = lecture_semester_id
            lecture_vo.lecture_subject_id = lecture_subject_id
            lecture_vo.lecture_semester_id = lecture_semester_id
            lecture_vo.lecture_faculty_id = faculty_id
...
# @app.route('/faculty/ajax_course_lecture')
# def faculty_ajax_course_lecture():
#     try:
#         if admin_login_session() == "faculty":
#             course_vo = CourseVO()
#             course_dao = CourseDAO()
#             course_degree_id = request.args.get('lectureDegreeId')
#             course_vo.course_degree_id = course_degree_id
#
#             course_vo_list = course_dao.view_ajax_course(
#                 course_vo)
#             ajax_lecture_course = [i.as_dict() for i in
#                                        course_vo_list]
#             return jsonify(ajax_lecture_course)
#         else:
#             return admin_logout_session()
#     except Exception as ex:
#         print("faculty_ajax_course_lecture route exception "
#               "occured>>>>>>>>>>>>", ex)
#
#
...
#             semester_vo = SemesterVO()
#             semester_dao = SemesterDAO()
#             semester_course_id = request.args.get('lectureDepartmentId')
