...
def student_view_exam():
    try:
        if admin_login_session() == "student":
            ...
            return render_template('student/viewExam.html',
                                   exam_vo_list=exam_vo_list)
        else:
            return admin_logout_session()
    except Exception as ex:
        ...
        # @app.route('/faculty/ajax_course_exam')
        # def faculty_ajax_course_exam():
        #     try:
        #         if admin_login_session() == "faculty":
        #             course_vo = CourseVO()
        #             course_dao = CourseDAO()
        #             course_degree_id = request.args.get('examDegreeId')
        ...
        #             return admin_logout_session()
        #     except Exception as ex:
        #         print("faculty_ajax_course_exam route exception "
        #               "occured>>>>>>>>>>>>>>", ex)
        #
        #
        ...
        #             semester_vo = SemesterVO()
        #             semester_dao = SemesterDAO()
        #             semester_course_id = request.args.get('examCourseId')
